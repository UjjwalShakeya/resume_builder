...
const SkillsForm = ({ data, onChange }) => {
    ...
    // creating the state of Skills
    const [newSkill, setNewSkill] = useState("");


    // adding a new Skill handeler
    const addSkill = () => {
    ...
    return (
        <div className='space-y-4'>
            <div>
                <h3 className='flex items-center gap-2 text-lg font-semibold text-grey-900'>Skills</h3>
